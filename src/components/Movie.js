...
// post to toggleMovie this Movie
...
// Fetch more Movie data from API & show/hidden DataDiv 
...
// Show and hidden Haerts and start UpdateDB
...
function Movie(props) {
    ...
    const MovieWebUniqueID = Movie.imdbID + props.showList; // Create a unique ID
    return (
